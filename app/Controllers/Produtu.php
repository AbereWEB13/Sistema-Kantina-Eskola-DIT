...
class Produtu extends BaseController
{
...

    {
        ...
        $dptD = new M_Produtu();
        $builder = $dptD->builder('tbl_produtu as pr');
        $builder->join('tbl_kategoria as ka', 'ka.id_kategoria = pr.id_kategoria');
        $builder->select('pr.id_produtu,pr.naran_produtu,ka.naran_kategoria,pr.presu');


        $query = $builder->get();
        $data['produtu'] = $query->getResult();
    ...
    public function delete($id)
    {
        ...
        $data = $model->select('pr.id_produtu,pr.naran_produtu,ka.naran_kategoria,pr.presu')
    ...
    public function note($id_produtu)
    {
        ...
        $produtu = $produtuModel->select('pr.id_produtu,pr.naran_produtu,ka.naran_kategoria,pr.presu')
            ->from('tbl_produtu as pr')
            ->join('tbl_kategoria as ka', 'ka.id_kategoria = pr.id_kategoria')
        ...
        if (!$produtu) {
            return redirect()->to('/produtu')->with('flash', 'produtu la hetan!');
        }
