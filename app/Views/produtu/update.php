                    ...
                    <form action="<?= base_url('produtu/update') ?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6"> <!-- Kolom pertama -->
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-company">ID Kareira</label>
                                    <input type="text" class="form-control" id="basic-default-company" name="id_produtu" value="<?= $produtu['id_produtu'] ?>">
                                </div>
