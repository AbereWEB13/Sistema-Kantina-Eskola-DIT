                        ...
                        <div class="row">
                            <div class="col-md-6"> <!-- Kolom pertama -->
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="basic-default-company" name="id_pagamentu" value="<?= $pagamentu['id_pagamentu'] ?>">
                                </div>
                            ...
                            <div class="col-md-6"> <!-- Kolom kedua -->
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="basic-default-company" name="data_pagamentu" value="<?= $pagamentu['data_pagamentu'] ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="basic-default-company" name="data_atualiza" value="<?= $pagamentu['data_atualiza'] ?>">
                                </div>
                            </div>
                        </div>
